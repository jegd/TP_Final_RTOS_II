...
Core/Startup/%.o: ../Core/Startup/%.s Core/Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"D:/Especialidad sistemas embebidos UBA/RTOS (II)/TPfinal/RTOSII_tpfinal/src2/app/inc" -I"D:/Especialidad sistemas embebidos UBA/RTOS (II)/TPfinal/RTOSII_tpfinal/src2/lib/inc" -I"D:/Especialidad sistemas embebidos UBA/RTOS (II)/TPfinal/RTOSII_tpfinal/src2/hal/inc" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
